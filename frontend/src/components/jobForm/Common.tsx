          ...
          <div className="flex items-center gap-2">
            ...
            {!emailNotifications && (
              <div className="relative group">
                <HelpCircle size={18} className="text-gray-500 cursor-pointer hover:text-purple-600" />
                <div
                  className="absolute left-1/2 -translate-x-1/2 top-full mt-1 w-48 text-xs text-white bg-gray-800 
      ...
      <div className="border border-gray-200 rounded-lg px-4 py-6 space-y-6">
        ...
        <div className="flex flex-col space-y-1 mt-4">
          <div className="flex items-center justify-between">
            <label htmlFor="cron" className="font-medium text-gray-700">
              Cron Expression
            </label>
            <button
              type="button"
