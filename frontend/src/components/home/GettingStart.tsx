      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Quick Deploy</h3>
            <p className="text-gray-600 mb-6">Get up and running with our simple deployment guide</p>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Contribute</h3>
            <p className="text-gray-600 mb-6">Join our community and help improve the project</p>
            <div className="space-y-2 mb-6">
              <div className="flex items-center text-sm text-gray-600">
                <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
