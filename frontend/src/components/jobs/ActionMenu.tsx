  ...
  return (
    <div className="bg-white border border-gray-200 rounded shadow-md text-sm flex flex-col">
      <Link
        ...
        className="w-full sm:hidden flex items-center gap-2 px-4 py-2 hover:bg-gray-100"
      >
      ...
      <Link
        to={`/job/${_id}/logs`}
        onClick={() => setOpen(false)}
        className="sm:hidden w-full flex items-center gap-2 px-4 py-2 hover:bg-gray-100"
      >
