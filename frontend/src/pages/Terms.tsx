    ...
    <div className="bg-gray-50 min-h-screen font-[Inter]">
      ...
      <main className="max-w-4xl mt-16 mb-10 mx-auto px-4 py-12 space-y-10">
        <section className="space-y-5">
          ...
          <p>
            Welcome to <strong>CronJob Scheduler</strong>! By accessing or using our service, you agree to be bound by
        ...
        <section>
          ...
          <p>
            CronJob Scheduler is an open-source platform designed for scheduling, managing, and monitoring automated
            tasks. You may use it for lawful purposes only. You agree not to upload, share, or distribute content that
            is illegal, harmful, or infringes on the rights of others.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            and for all activities that occur under your account. Notify us immediately of any unauthorized access or
            use.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All content, features, and functionality of CronJob Scheduler, including code, design, and trademarks, are
            owned by us or our licensors. You may not copy, modify, distribute, or create derivative works without
            explicit permission, except as allowed by the open-source license.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Our Service may integrate with third-party services such as email providers or cloud platforms. We are not
            responsible for the terms, privacy policies, or practices of these third parties.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            are not liable for any damages or losses resulting from your use or inability to use the Service.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We may update these Terms periodically. Users will be notified via email or a notice on the website.
        ...
        <section>
          ...
          <p>
            These Terms are governed by the laws of Pakistan. However, CronJob Scheduler is an open-source project
            available worldwide, and by using it, you agree to comply with local laws applicable in your country.
          </p>
        </section>
